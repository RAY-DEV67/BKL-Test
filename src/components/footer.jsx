...
function Footer() {
  return (
    <div className="flex flex-col lg:flex-row justify-between py-[16px] px-[20px]">
      <div className="flex items-center">
        <img src={logo} alt="Logo" />
        <p className="text-white ml-[4px]">NEPTIS</p>
      </div>
      <ul className="w-[528px] flex flex-col my-[40px] text-white lg:flex-row lg:my-[0px] lg:justify-between">
        <li>Home</li>
        <li>Features</li>
        <li>How it works</li>
        <li>Pricing</li>
